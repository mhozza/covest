...
from covest.tools.table_generator import format_table, square_table
...
def main(args):
    ...
    header, lines = square_table('original_error_rate', 'original_coverage', 'estimated_coverage', table_lines)
